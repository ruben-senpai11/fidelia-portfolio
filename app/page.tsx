    ...
    <>
      ...
      <main className="flex flex-col items-center justify-between ">
        <section id="hero" className="">
          <div className="introduction hero-background px-[0%] py-[15%] flex flex-col justify-center items-center gap-8">
          ...
          <div className="introduction px-[1%] py-[10px] pb-16 flex flex-col justify-center items-center gap-6  ">
