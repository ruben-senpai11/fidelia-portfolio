  ...
  return (
    ...
    <>
      <div className="nav-links items-center justify-center relative ">
        <ul className={(width > 1000 && isScrolled ? "opacity-55 hover:opacity-100 " : "opacity-100 ") + "flex items-center justify-between gap-6 max-w-100 bg-zinc-700 px-6 py-[7px] transition-all "}>
