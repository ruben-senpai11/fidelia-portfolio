        ...
        <div className="footer-grid pt-16 flex w-[100%]">
          <div className="footer-left w-[50%] h-[100%] ">
            <div className="flex flex-col gap-5 items-start ">
              <Logo /> 
              <h3 className="w-[85%] ">La mode basée sur les traditions africaines, le style contemporain et les valeurs de la femme.</h3>
            </div>
          </div>
          <div className="footer-right flex justify-between md:justify-end gap-8 w-[50%] pt-3 ">
            <div className="footer-col flex flex-col gap-6">
              ...
              <a href="https://wa.me/+22994065204" >Créer mon modèle sur mesure</a>
            ...
            <div className="footer-col flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <a href="https://www.facebook.com/fidelia-houngbedji/">Facebook</a>
                <a href="tel:+2290194065204">Téléphone</a>
              </div>
            </div>
            {/* <div className="footer-col flex flex-col gap-6">
